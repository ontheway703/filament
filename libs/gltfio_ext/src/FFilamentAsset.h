...
#ifndef GLTFIO_EXT_FFILAMENTASSET_H
#define GLTFIO_EXT_FFILAMENTASSET_H
...
#define GLTFIO_EXT_WARN(msg) slog.w << msg << io::endl
#endif

#ifndef GLTFIO_EXT_USE_FILESYSTEM
#if defined(__EMSCRIPTEN__) || defined(__ANDROID__) || defined(FILAMENT_IOS)
#define GLTFIO_EXT_USE_FILESYSTEM 0
#else
#define GLTFIO_EXT_USE_FILESYSTEM 1
#endif
#endif
...
#endif // GLTFIO_EXT_FFILAMENTASSET_H
