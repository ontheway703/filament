...
#ifndef GLTFIO_EXT_TEXTUREPROVIDER_H
#define GLTFIO_EXT_TEXTUREPROVIDER_H
...
template<> struct utils::EnableBitMaskOperators<filament::gltfio_ext::TextureProvider::TextureFlags>
        : public std::true_type {};

#endif // GLTFIO_EXT_TEXTUREPROVIDER_H
