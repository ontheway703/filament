...
project(Filament05antialiasing)

add_library(05_anti_aliasing STATIC
    src/05_anti_aliasing.cpp
)

target_link_libraries(05_anti_aliasing PUBLIC filament)
```
...
通过系统学习，可以在 Filament 中实现高质量的抗锯齿技术效果。
